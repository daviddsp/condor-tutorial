...
class Ejercicios extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nb_ejercicios, cont_ejercicios, id_contenidos', 'required'),
			...
			array('id_ejercicios, nb_ejercicios, des_ejercicios, cont_ejercicios, id_contenidos', 'safe', 'on'=>'search'),
		);
	}
